...
import { makeScoreBar } from "../ui/scoreBar.js";
import { getScore, resetScore, loadInitialScore } from "../state/scoreManager.js";
...
export async function room1(
  ...
  // Add score bar (do not reset here — preserve score across rooms)
  k.add(makeScoreBar(k, getScore));
}
